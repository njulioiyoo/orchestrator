                        ...
                        <ul id="main-menu" class="metismenu li_animation_delay">
                            ...
                            <li>
                                <a href="#charts" class="has-arrow"><i
                                        class="fa fa-area-chart"></i><span>Charts</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="#Pages" class="has-arrow"><i class="fa fa-file"></i><span>Extra
                                        Pages</span></a>
                                <ul>
                    ...
                    <ul class="right_chat list-unstyled li_animation_delay">
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="../../js/images/xs/avatar1.jpg" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="../../js/images/xs/avatar2.jpg" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="../../js/images/xs/avatar3.jpg" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="../../js/images/xs/avatar4.jpg" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="../../js/images/xs/avatar5.jpg" alt="">
                                <div class="media-body">
